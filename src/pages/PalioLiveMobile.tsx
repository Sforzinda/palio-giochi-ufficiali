                          ...
                          {group.results.map((result) => {
                            ...
                            return (
                              <div
                                ...
                                className="grid grid-cols-[minmax(0,1fr)_52px_70px] items-center gap-2 rounded-md bg-black/20 bg-cover bg-center px-2 py-2"
                                style={
                                  stemma
                ...
                <section className="rounded-xl border border-amber-200/25 bg-black/20 p-3">
                  ...
                  <div className="space-y-1.5">
                    {ranking.map((item) => {
                      ...
                      <div
                        key={item.id}
                        className="grid grid-cols-[36px_minmax(0,1fr)_64px] items-center gap-2 rounded-lg bg-amber-50/8 bg-cover bg-center px-2.5 py-2.5"
                        style={
                          stemma
                            ? { backgroundImage: `linear-gradient(90deg, rgba(10,6,4,.82), rgba(10,6,4,.55) 55%, rgba(10,6,4,.82)), url(${stemma})` }
                            : undefined
